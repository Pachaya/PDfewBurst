...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PARAM1 = PARAMETERS{1}.PARAM;
PARAM2 = PARAMETERS{2}.PARAM;
...
%         disp( [lblTxt2 ' = ' num2str(PARAM2(p2_ii)) ]);
        ...
        Name_postfix_WT  = ACT_Record{p1_ii,p2_ii,p3_ii,p4_ii,p5_ii}.SimulationCode;  % The connection is same for WT and KO
