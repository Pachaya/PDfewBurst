...
dirFig = 'Fig_best_10s/';
mkdir([dirLoc dirFig])
InFR_CODENAME = 'PoisInputFr150403_newExp';
...
for TRIAL_NO = 1 :NUM_TRIAL
    for cell_type = 1 : 2
        ...
        %PDfewBurst_GPmVLmd1_KO_InGauss0.2_IGmean0_IGmeanSig0_W0.029_SpecifiedPoisSpk_sig0.00Hz_T100000_trial5
...
xx = 0 :1:35;
yfit = 147.3 * exp(0.006698.*xx) - 147.4; %parameter search result


ff = figure;  set(gcf, 'PaperPositionMode','Auto');
plot(xx,yfit,'k.-');
