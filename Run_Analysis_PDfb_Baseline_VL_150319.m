...
dirLoc = 'CellModel1_MinParam150319_2/' ; %'TestSim_BasalAct/';  %'VL_LocalConn/';
...
for TRIAL_NO = 1 :NUM_TRIAL
    for cell_type = 1 : 2
        ...
        Name_postfix = [coreFileName '_' cTxt '_InGauss' num2str(InGauss_STDEV) '_IGmean' num2str(NoiseMEAN) '_IGmeanSig' num2str(IGmeanSig) '_W' num2str(W_Weight) '_Wsig' num2str(W_sig) '_SpecifiedPoisSpk_sig' num2str(PoisInputSig)  '.00Hz_T' num2str(TSTOP) '_trial' num2str(TRIAL_NO) ];
