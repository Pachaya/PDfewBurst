...
DoTTest = 1;
SAVE_BASAL_ACT = 0;
FNAME_SIM = 'MinParam150324' ; %'PreLim_INOISE0.2_InSPK50_EE1_EI2_IE20_II12_mult125_w0.0006';
plotSampleV = 0;
...
FIG_ALL = 0;
dirFig = 'Fig_TC_GPm_w_mn0.06_GPm_w_sg0.02/';
mkdir([dirLoc dirFig])
...
for p1_ii = 1 : length(PARAM1)
    for p2_ii = 1 : length(PARAM2)
        ...
        for cell_type = 1 : 2
            ...
            GPmLight = 0.3; GPm_w_mn =0.06; GPm_w_sg = 0.02;
            TRIAL_NO = 1;
...
%             GPm_w_sg = GPmVLw_sig_LST(s_ii);
            ...
            %PDfewBurst_GPmVLmd1_rTC120_wmTC10_WT_GPmInput_Amp0.3_Dur1000_GPmVLw_m0.06_sig0.01_InGauss0.2_IGmean-0.15_IGmeanSig0_W0.0015_SpecifiedPoisSpk_sig0.00Hz_T4000_trial3
            %PDfewBurst_GPmVLmd1_rTC120_wmTC4_WT_GPmInput_Amp0.3_Dur1000_GPmVLw_m0.1_sig0.01_InGauss0.2_IGmean-0.15_IGmeanSig0_W0.0012_SpecifiedPoisSpk_sig0.00Hz_T4000_trial1
