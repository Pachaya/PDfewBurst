...
TRIAL = nn;
% for nc = 1 : N_CELL
%     disp(num2str(Input_FR_WT(nc,TRIAL),'%4.2f'))
% end    
dlmwrite(['PoisInputFr_KO_' num2str(TRIAL) '.txt'],Input_FR_WT(:,nn),'delimiter','\n')
dlmwrite(['PoisInputFr_WT_' num2str(TRIAL) '.txt'],Input_FR_KO(:,nn),'delimiter','\n')
myl = 1000;
