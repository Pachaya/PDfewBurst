...
dirLoc = 'Model1_MinParam150327_fullsim/' ; %'TestSim_BasalAct/';  %'VL_LocalConn/';
...
%                 GPm_w_mn = 0.06; GPm_w_sg = 0.01;
            ...
            ChanceOfBurstingKO(p1_ii,p2_ii,p3_ii) =  sum((ACT_Record{p1_ii,p2_ii,p3_ii}.KO.All.BurstSpk > 0))/(nE+nI); %%%%% will not work if the KO has base line activity --> try add more condition ex. 1st & 2nd ISI < 4ms
