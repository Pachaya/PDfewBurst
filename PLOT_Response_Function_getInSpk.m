...
%         p3_ii = 1;
        ...
        figure(rf);
        errorbar(avgInputFR(:,p2_ii,p3_ii,p4_ii), avgFR(:,p2_ii,p3_ii,p4_ii,1),stdFR(:,p2_ii,p3_ii,p4_ii,1),[getDotStyle(mm) getLineStyle(1) getColorCode(mm)], 'LineWidth',2); hold on;
        errorbar(avgInputFR(:,p2_ii,p3_ii,p4_ii), avgFR(:,p2_ii,p3_ii,p4_ii,2),stdFR(:,p2_ii,p3_ii,p4_ii,2),[getDotStyle(mm) getLineStyle(2) getColorCode(mm)], 'LineWidth',2);
        figure(ef);
        errorbar(avgInputFR(:,p2_ii,p3_ii,p4_ii), avgEff(:,p2_ii,p3_ii,p4_ii,1),stdEff(:,p2_ii,p3_ii,p4_ii,1),[getDotStyle(mm) getLineStyle(1) getColorCode(mm)], 'LineWidth',2); hold on;
        errorbar(avgInputFR(:,p2_ii,p3_ii,p4_ii), avgEff(:,p2_ii,p3_ii,p4_ii,2),stdEff(:,p2_ii,p3_ii,p4_ii,2),[getDotStyle(mm) getLineStyle(2) getColorCode(mm)], 'LineWidth',2);
...
%         else
             tmpTxt =  get_Parameters_titleText(PARAMETERS,[mainID],[mm]);
