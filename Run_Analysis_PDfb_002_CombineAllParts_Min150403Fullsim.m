        ...
        for p3_ii = 1 : length(PARAM3)
            for p4_ii = 1 : length(PARAM4)
                for p5_ii = 1 : length(PARAM5)
                    ...
                    clear tmpWTtrain_M1 tmpWTtrain_VL tmpKOtrain_M1 tmpKOtrain_VL
                end
            end
        end
    end
...
% meanNoiseCurrent_PDfewBurst_GPmVLmd1_0del_rTC120_wmTC7_KO_GPmInput_Amp0.4_Dur1000_GPmVLw_m0.04_sig0.01_InGauss0.2_IGmean0_IGmeanSig0_W0.029_SpecifiedPoisSpk_sig0.00Hz_T4000_trial1
% SpatialConnectionWDParam_M1PDfewBurst_GPmVLmd1_0del_rTC190_wmTC10_WT_GPmInput_Amp0.4_Dur1000_GPmVLw_m0.06_sig0_InGauss0.2_IGmean0_IGmeanSig0_W0.029_SpecifiedPoisSpk_sig0.00Hz_T4000_trial1
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%    GPM - VL Connnection
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%  Recorde Weight of Connection

%    SpatialConnectionWDParam
