...
dirLoc = 'GPmVL2/' ; %'TestSim_BasalAct/';  %'VL_LocalConn/';
    ...
    for p2_ii = 1 : length(PARAM2)
        for p3_ii = 1 : length(PARAM3)
            la_ii = p1_ii; m_ii = p2_ii; s_ii = p3_ii;            
                ...
                simTxt = ['I_A_m_p =' num2str(GPmLight) ',GPmVL mean =' num2str(GPm_w_mn) ', sig =' num2str(GPm_w_sg)];
...
for p1_ii = 1 : length(PARAM1)
    ...
    for p2_ii = 1 : length(PARAM2)
        ...
        title(['Mean = ' num2str(PARAM2(p2_ii))]);
