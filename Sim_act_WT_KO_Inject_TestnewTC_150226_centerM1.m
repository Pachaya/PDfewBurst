...
for cell_type = 1 : 2
    ...
    if(SPECIFIED_RATIO)
        ...
        tmpTxt = Name_postfix;
        Name_postfix = [tmpTxt  '_' num2str(PoisInputFr) '.00Hz' '_rEE' rEE '_rEI' rEI '_rIE' rIE '_rII' rII '_Wmult' WMult ]; % For first run that did not add InSpk = 50 Hz in Name
    end
